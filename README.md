...
| Analytics | Monthly/yearly charts, spending calendar heatmap (day-level density for the month), category breakdown, top merchants for the period, period comparison, chart drill-down + shareable filter bar |
