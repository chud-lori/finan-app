  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        type="button"
        onClick={() => setOpen(v => !v)}
        className="w-full flex items-center gap-2.5 px-3.5 py-2.5 rounded-xl border border-gray-300 text-base bg-white hover:border-teal-400 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition text-left"
      >
        ...
        <div className="absolute z-30 bottom-full mb-1.5 bg-white border border-gray-200 rounded-2xl shadow-xl overflow-hidden" style={{ minWidth: 300 }}>
          ...
          <div className="border-t border-gray-100 px-4 py-3 flex items-center gap-3">
            ...
            <input
              ...
              className="flex-1 text-base px-2.5 py-1.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 bg-white"
            />
          </div>
