...
describe('day readout — the number a phone can reach without hover', () => {
  it('reports a day total that matches the rows the drill-down will show', () => {
    const txns = [
      tx({ amount: 20_000, time: '2026-08-06T05:00:00.000Z' }),
      tx({ amount: 30_000, time: '2026-08-06T09:00:00.000Z' }),
      tx({ amount: 5_000, category: 'reksa dana', time: '2026-08-06T10:00:00.000Z' }),
    ];
    ...
    expect(byDay['2026-08-06']).to.equal(50_000);
