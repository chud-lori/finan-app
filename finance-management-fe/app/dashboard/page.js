    ...
    <AuthGuard>
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 pb-24 md:pb-6">
          ...
          {/* Quick-access to Planner — mobile only. Insights lives in the bottom
              nav now, so it no longer needs a shortcut tile here; Planner is the
              one primary page not in the bottom bar. */}
          <div className="sm:hidden mb-6">
            <Link href="/recommendation"
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">FIRE, debt payoff, budgeting & 11 tools</p>
              </div>
            </Link>
          </div>
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <input
              ...
              className="flex-1 min-w-0 text-base sm:text-sm border border-gray-200 rounded-lg px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-teal-500"
